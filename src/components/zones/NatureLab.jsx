...
const NatureLab = ({ themeId, onBack, onSelectGame }) => {
  ...
  return (
    <div
      ...
      dir="rtl"
    >
      <div className="absolute inset-0 bg-gradient-to-b from-green-900/30 via-transparent to-lime-900/30 pointer-events-none" />

      <div className="max-w-3xl w-full relative z-10">
        {/* Header */}
        <div className="text-center mb-12">
          <div className="text-8xl mb-4 drop-shadow-2xl" role="img" aria-label="microscope">
            🔬
          </div>
          <h1 className="text-4xl sm:text-5xl font-black text-white mb-3 drop-shadow-2xl leading-tight">
            מעבדת הטבע
          </h1>
          <p className="text-xl text-white/80">🌿 🔬 בחר משחק והתחל לגלות!</p>
        </div>
