...
const GAMES = [
  ...
  },
  {
    id: 'balloonParty',
    name: 'מסיבת הבלונים',
    description: 'מצא את האות הנכונה על הבלון!',
    icon: '🎈',
...
const LetterKingdom = ({ themeId, onBack, onSelectGame }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-purple-900/30 via-transparent to-indigo-900/30 pointer-events-none" />

      <div className="max-w-3xl w-full relative z-10">
        {/* Header */}
        <div className="text-center mb-12">
          <div className="text-8xl mb-4 drop-shadow-2xl" role="img" aria-label="castle">
            🏰
          </div>
          <h1 className="text-4xl sm:text-5xl font-black text-white mb-3 drop-shadow-2xl leading-tight">
            ממלכת האותיות והמילים
          </h1>
